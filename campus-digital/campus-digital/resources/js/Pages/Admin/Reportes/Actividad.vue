            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Historial completo de actividades realizadas en el sistema.
                    </p>
                </div>
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="actividad in actividades.data" :key="actividad.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ actividad.usuario ? `${actividad.usuario.nombre} ${actividad.usuario.apellido}` : 'Sistema' }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ actividad.target_tabla ? `${actividad.target_tabla}#${actividad.target_id}` : 'N/A' }}
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <span class="max-w-xs truncate block">{{ actividad.detalle || 'N/A' }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <!-- Paginación -->
                    <div v-if="actividades.links.length > 3" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a 
                                    v-for="(link, index) in actividades.links" 
                                    :key="index"
                                    :href="link.url"
                                    v-html="link.label"
                                    :class="[
...
const filtrar = () => {
    router.get(route('admin.reportes.actividad'), form, {
        preserveState: true,
        preserveScroll: true,
    });
};
...
const exportarCSV = () => {
    ...
    window.location.href = route('admin.reportes.actividad') + '?' + params.toString();
};
