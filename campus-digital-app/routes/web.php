...
use App\Http\Controllers\Recargas\SimulacionController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // MODULO 8 - RECARGAS, WALLET Y SIMULACIONES
    Route::prefix('modulo_8')->name('modulo_8.')->group(function () {
        ...
        // Simulaciones de consumo por módulo (cafeteria, copias, souvenirs, biblioteca, acceso)
        Route::post('/simular', [SimulacionController::class, 'simular'])->name('simular');
        Route::get('/historial', [SimulacionController::class, 'historial'])->name('historial');
