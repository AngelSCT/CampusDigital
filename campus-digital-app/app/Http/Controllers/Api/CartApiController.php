...
{
    // ÔöÇÔöÇÔöÇ Helpers ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Endpoints ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

    /**
     * GET /api/v1/carrito/usuarios/{id}/stats
     * Total gastado, ├║ltimo pedido (con ticket formal) y carrito activo.
     */
     ...
     * Top 5 productos m├ís vendidos (Dashboard Admin).
     */
     ...
     * Verificaci├│n p├║blica de autenticidad de un ticket (sin API key).
     */
    public function validarHash(string $hash): JsonResponse
    {
        ...
        foreach ($pedidos as $pedido) {
            ...
            if (hash_equals($hashEsperado, $hash)) {
                return response()->json([
                    'status'  => 'success',
                    'mensaje' => 'Ticket aut├®ntico y verificado.',
                    'ticket'  => [
                        'folio'       => 'CD-2026-' . str_pad($pedido->id, 5, '0', STR_PAD_LEFT),
                        'estado'      => $pedido->estado,
                        'metodo_pago' => $pedido->metodo_pago,
        ...
        return response()->json([
            'status'  => 'error',
            'mensaje' => 'Hash inv├ílido. Este ticket no pudo ser verificado.',
        ], 404);
    }
