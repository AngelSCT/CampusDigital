        ...
        <div class="dashboard-container">
            ...
            <div class="section">
                ...
                <div class="quick-grid">
                    ...
                    <a :href="route('admin.tickets.index')" class="quick-card ticket"><svg class="quick-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/></svg><span>Tickets</span></a>
                </div>
            </div>
...
.quick-card.ticket{border-color:rgba(249,115,22,0.4)} .quick-card.ticket:hover{border-color:#f97316;background:rgba(249,115,22,0.12)} .quick-card.ticket .quick-icon{color:#fb923c}
