        ...
        <div class="dashboard-container">
            ...
            <div class="section">
                ...
                <div class="quick-grid">
                    ...
                    <a :href="route('admin.monedero.dashboard')" class="quick-card teal"><svg class="quick-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg><span>Monedero · Estado de Cuenta</span></a>
                    <a :href="route('admin.monedero.reportes.movimientos')" class="quick-card rose"><svg class="quick-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/></svg><span>Monedero · Movimientos</span></a>
                </div>
            </div>
...
.quick-card.teal{border-color:rgba(13,148,136,0.4)} .quick-card.teal:hover{border-color:#0D9488;background:rgba(13,148,136,0.12)} .quick-card.teal .quick-icon{color:#14b8a6}
.quick-card.rose{border-color:rgba(190,18,60,0.4)} .quick-card.rose:hover{border-color:#BE123C;background:rgba(190,18,60,0.12)} .quick-card.rose .quick-icon{color:#f43f5e}
