                ...
                <div class="form-container">
                    ...
                    <div class="form-header">
                        ...
                        <h2 class="welcome-title">
                            <span class="title-purple">Recuperar</span> Contraseña
                        </h2>
                        <p class="welcome-sub">
            ...
            >
                ...
                <div class="right-content">
                    ...
                    <div class="right-text">
                        <h2>Recupera<br><span class="right-title-accent">tu Acceso</span></h2>
                        <p>Tu información está protegida. Te enviaremos un enlace seguro para restablecer tu contraseña.</p>
                    </div>
                    ...
                    <div class="right-stats">
                        ...
                        <div class="stat-pill">
                            ...
                            <span class="stat-pill-label">Rápido</span>
                        </div>
                        <div class="stat-pill">
...
.key-icon-wrapper i { font-size: 1.5rem; color: #a855f7; }
...
.welcome-sub  { font-size: 0.8rem; color: #94a3b8; line-height: 1.5; }
...
.register-text { text-align: center; margin-bottom: 0.75rem; }
...
@media (max-height: 700px) and (min-width: 769px) {
    ...
    .key-icon-wrapper    { width: 46px; height: 46px; margin-bottom: 0.6rem; }
    .key-icon-wrapper i  { font-size: 1.2rem; }
}
