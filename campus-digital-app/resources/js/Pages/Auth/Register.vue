            ...
            <div class="split-left">
                ...
                <div class="form-container">
                    ...
                    <div class="form-header">
                        ...
                        <h2 class="welcome-title">Crear una cuenta</h2>
                    ...
                    <div class="form-footer">
                        ...
                        <p class="register-text">
                            ¿Ya tienes cuenta?
                            <Link :href="route('login')" class="register-link">Inicia sesión</Link>
                        </p>
                    </div>
            ...
            >
                ...
                <div class="right-content">
                    ...
                    <div class="right-text">
                        <h2>Únete al<br><span class="right-title-accent">Campus Digital</span></h2>
                        <p>Crea tu cuenta y accede a todas las herramientas de gestión escolar desde un solo lugar.</p>
                    </div>
...
.register-text { text-align: center; color: #94a3b8; font-size: 0.78rem; }
.register-link {
...
@media (max-height: 700px) and (min-width: 769px) {
    ...
    .form-input     { padding: 0.5rem 0.9rem; }
    .btn-login      { padding: 0.65rem; }
}
