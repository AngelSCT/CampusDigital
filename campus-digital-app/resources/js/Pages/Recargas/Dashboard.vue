    ...
    <AuthLayout>
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link
                    :href="route('modulo_8.reportes.historial', { periodo: periodo })"
                    class="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-xl hover:border-cyan-500 transition group"
                >
                    <div class="flex items-center justify-between mb-2">
                ...
                <Link
                    :href="route('modulo_8.reportes.fallidos', { periodo: periodo })"
                    class="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-xl hover:border-red-500 transition group"
                >
                    <div class="flex items-center justify-between mb-2">
                ...
                <Link
                    :href="route('modulo_8.reportes.conciliacion')"
                    class="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-xl hover:border-purple-500 transition group"
                >
                    <div class="flex items-center justify-between mb-2">
...
const props = defineProps({
    ...
    metodos: { type: Object, default: () => ({}) },
    ultimas: { type: Array,  default: () => [] },
    periodo: { type: String, default: '30' },
});
...
function badgeEstado(estado) {
    if (estado === 'exitoso') return 'bg-green-500/20 text-green-300';
