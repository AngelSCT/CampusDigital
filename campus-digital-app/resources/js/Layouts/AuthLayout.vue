            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex min-w-0 flex-1">
                        ...
                        <div class="hidden sm:ml-6 sm:flex sm:items-center sm:gap-x-5 whitespace-nowrap">
                            ...
                            <template v-if="isAdmin">
                                <div class="relative">
                                    <button
                                        ...
                                        class="text-white hover:text-blue-400 inline-flex items-center px-3 py-2 text-sm font-medium transition-all duration-300"
                                    >
                                        ⚙ Administración
                                    ...
                                    <div
                                        ...
                                        class="absolute left-0 top-full mt-2 w-64 rounded-xl bg-slate-900 border border-blue-500/20 shadow-2xl z-[9999]"
                                    >
                                        <a href="/categorias" class="admin-link">Categorías</a>
                                        <a href="/areas" class="admin-link">Áreas</a>
                                        <a href="/precios" class="admin-link">Precios</a>
                                        <a href="/disponibilidad" class="admin-link">Disponibilidad</a>
                                        <a href="/reglas" class="admin-link">Reglas</a>

                                        <Link :href="route('admin.usuarios.index')" class="admin-link">
                                            Usuarios
                                        </Link>

                                        <Link :href="route('admin.tiendas.index')" class="admin-link">
                                            Tiendas
                                        </Link>

                                        <Link :href="route('admin.proveedores.index')" class="admin-link">
                                            Proveedores
                                        </Link>

                                        <Link :href="route('admin.roles.index')" class="admin-link">
                                            Roles
                                        </Link>

                                        <a href="/admin/permisos" class="admin-link">
                                            Permisos
                                        </a>

                                        <a href="/admin/bitacora/accesos" class="admin-link">
                                            Bitácora
                                        </a>

                                        <a href="/admin/tarjetas/dashboard" class="admin-link">
                                            Tarjetas
                                        </a>

                                        <Link :href="route('admin.tickets.index')" class="admin-link">
                                            Tickets
                                        </Link>

                                        <a href="/pedidos" class="admin-link">
                                            Pedidos
                                        </a>

                                        <a href="/admin/monedero/dashboard" class="admin-link">
                                            Monedero
                                        </a>
                                    </div>
                                </div>
