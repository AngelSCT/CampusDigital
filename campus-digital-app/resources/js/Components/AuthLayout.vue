<template>
    ...
    >
        ...
        >
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <template v-if="tieneRol('administrador')">
                                ...
                                <div
                                    class="relative inline-flex items-center px-1 pt-1"
                                >
                                    <button
                                        @click="
                                            mostrarMenuReportes =
                                        ...
                                        >
                                            <div class="py-1">
                                                <a
                                                    ...
                                                    "
                                                    class="block px-4 py-2.5 text-sm text-slate-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200"
                                                >
                                                    Usuarios
                                                </a>
                                                <a
                                ...
                                >
                                    <button
                                        ...
                                        :class="[
                                            'inline-flex items-center px-1 border-b-2 text-sm font-medium transition-all duration-300',
                                            estaActiva('admin.tickets') ||
                                            estaActiva('admin.asignaciones') ||
                                            estaActiva(
                                                'admin.mantenimientos',
                                            ) ||
                                            estaActiva('admin.equipos') ||
                                            estaActiva('admin.categorias') ||
                                            estaActiva('admin.ubicaciones')
                                                ? 'border-blue-500 text-blue-400 shadow-lg shadow-blue-500/20'
                                                : 'border-transparent text-slate-400 hover:border-blue-500/50 hover:text-slate-200',
                                        ]"
                                    >
                                    ...
                                    >
                                        <div
                                            v-show="mostrarMenuMantenimiento"
                                            @click="
                                                mostrarMenuMantenimiento = false
                                            "
                                            class="absolute top-full left-0 mt-2 w-56 rounded-xl shadow-2xl bg-gradient-to-br from-slate-800 to-slate-900 ring-1 ring-blue-500/30 z-50 overflow-hidden"
                                        >
                                            <div class="py-1">
                                                <a
                                                    :href="
                                                ...
                                                <a
                                                    :href="
                                                        route(
                                                            'admin.asignaciones-tecnicas.index',
                                                        )
                                                    "
                                                    class="block px-4 py-2.5 text-sm text-slate-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200"
                                                >
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center">
                        <div class="relative">
                            ...
                            >
                                <div
                                    class="h-9 w-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold mr-2 shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 group-hover:scale-105 transition-all duration-300"
                                >
                                    {{
                                        $page.props.auth?.user?.nombre?.charAt(
                                            0,
                                        ) || "U"
                                    }}{{
                                        $page.props.auth?.user?.apellido?.charAt(
                                            0,
                                        ) || ""
                                    }}
                                </div>
                                ...
                                >
                                    <div class="py-1">
                                        ...
                                        >
                                            <button
                                                type="submit"
                                                class="w-full text-left px-4 py-2.5 text-sm text-slate-300 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200"
                                            >
                                                Cerrar Sesión
                                            </button>
                                        </form>
            ...
            >
                <div
                    v-show="mostrarMenuMovil"
                    class="sm:hidden border-t border-blue-500/20 bg-slate-900/50 backdrop-blur-xl"
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="tieneRol('administrador')">
                            ...
                            <a
                                ...
                                :class="[
                                    'block pl-3 pr-4 py-2 border-l-4 text-base font-medium transition-all duration-300',
                                    estaActiva('admin.asignaciones-tecnicas')
                                        ? 'border-blue-500 text-blue-400 bg-blue-500/10'
                                        : 'border-transparent text-slate-400 hover:bg-slate-800/50 hover:text-slate-200',
                                ]"
                            >
                            ...
                            <a
                                ...
                                :class="[
                                    'block pl-3 pr-4 py-2 border-l-4 text-base font-medium transition-all duration-300',
                                    estaActiva('admin.equipos-activos')
                                        ? 'border-blue-500 text-blue-400 bg-blue-500/10'
                                        : 'border-transparent text-slate-400 hover:bg-slate-800/50 hover:text-slate-200',
                                ]"
                            >
                            ...
                            <a
                                ...
                                :class="[
                                    'block pl-3 pr-4 py-2 border-l-4 text-base font-medium transition-all duration-300',
                                    estaActiva('admin.categorias-ticket')
                                        ? 'border-blue-500 text-blue-400 bg-blue-500/10'
                                        : 'border-transparent text-slate-400 hover:bg-slate-800/50 hover:text-slate-200',
                                ]"
                            >
                    ...
                    <div class="pt-4 pb-3 border-t border-blue-500/20">
                        ...
                        <div class="mt-3 space-y-1">
                            <a
                                :href="route('perfil.show')"
                                class="block px-4 py-2 text-base font-medium text-slate-400 hover:bg-slate-800/50 hover:text-blue-400 transition-all duration-300"
                            >
                                Mi Perfil
                            </a>
                            <form @submit.prevent="logout">
                                <button
                                    type="submit"
                                    class="w-full text-left block px-4 py-2 text-base font-medium text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition-all duration-300"
                                >
                                    Cerrar Sesión
                                </button>
                            </form>
        ...
        <main>
            ...
            >
                <div
                    class="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-l-4 border-green-500 rounded-lg p-4 mb-4 backdrop-blur-sm shadow-lg shadow-green-500/10"
                >
                    <div class="flex">
            ...
            >
                <div
                    class="bg-gradient-to-r from-red-500/10 to-rose-500/10 border-l-4 border-red-500 rounded-lg p-4 mb-4 backdrop-blur-sm shadow-lg shadow-red-500/10"
                >
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg
...
const mostrarMenuMantenimiento = ref(false);
